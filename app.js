...
InstructionsContainer.innerHTML += `<div class="instrc-info">
<span class="instrc-info-span">${e.step}.</span>
<div class="instrc-span-para"> 
<p class="instrc-para"><span class="span-bold-text2">${e.title}: </span>  ${e.description }</p>
</div>
 </div>`;
});
